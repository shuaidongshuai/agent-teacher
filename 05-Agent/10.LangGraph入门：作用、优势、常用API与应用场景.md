# 10. LangGraph 入门：作用、优势、常用 API 与应用场景
...
3. 最后进入 [7.Agentic RAG：当Agent遇见检索.md](/Users/chenmingdong01/Documents/AI/agent/05-Agent/7.Agentic%20RAG：当Agent遇见检索.md) 把检索能力并入图流程
